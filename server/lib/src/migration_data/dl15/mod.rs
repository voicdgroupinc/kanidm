...
pub fn phase_1_schema_attrs() -> Vec<SchemaAttribute> {
    vec![
        SCHEMA_ATTR_SYNC_CREDENTIAL_PORTAL.clone(),
        SCHEMA_ATTR_SYNC_YIELD_AUTHORITY.clone(),
        ...
        SCHEMA_ATTR_BADLIST_PASSWORD.clone(),
        SCHEMA_ATTR_CREDENTIAL_UPDATE_INTENT_TOKEN.clone(),
        SCHEMA_ATTR_ATTESTED_PASSKEYS.clone(),
        SCHEMA_ATTR_DOMAIN_DISPLAY_NAME.clone(),
        SCHEMA_ATTR_DOMAIN_LDAP_BASEDN.clone(),
        SCHEMA_ATTR_DOMAIN_NAME.clone(),
        SCHEMA_ATTR_LDAP_ALLOW_UNIX_PW_BIND.clone(),
        SCHEMA_ATTR_DOMAIN_SSID.clone(),
        SCHEMA_ATTR_DOMAIN_TOKEN_KEY.clone(),
        SCHEMA_ATTR_DOMAIN_UUID.clone(),
        SCHEMA_ATTR_DYNGROUP_FILTER.clone(),
        SCHEMA_ATTR_ES256_PRIVATE_KEY_DER.clone(),
        SCHEMA_ATTR_FERNET_PRIVATE_KEY_STR.clone(),
        SCHEMA_ATTR_GIDNUMBER.clone(),
        SCHEMA_ATTR_GRANT_UI_HINT.clone(),
        SCHEMA_ATTR_JWS_ES256_PRIVATE_KEY.clone(),
        SCHEMA_ATTR_LOGINSHELL.clone(),
        SCHEMA_ATTR_NAME_HISTORY.clone(),
        SCHEMA_ATTR_NSUNIQUEID.clone(),
        SCHEMA_ATTR_OAUTH2_ALLOW_INSECURE_CLIENT_DISABLE_PKCE.clone(),
        SCHEMA_ATTR_OAUTH2_CONSENT_SCOPE_MAP.clone(),
        SCHEMA_ATTR_OAUTH2_JWT_LEGACY_CRYPTO_ENABLE.clone(),
        SCHEMA_ATTR_OAUTH2_PREFER_SHORT_USERNAME.clone(),
        SCHEMA_ATTR_OAUTH2_RS_BASIC_SECRET.clone(),
        SCHEMA_ATTR_OAUTH2_RS_IMPLICIT_SCOPES.clone(),
        SCHEMA_ATTR_OAUTH2_RS_NAME.clone(),
        SCHEMA_ATTR_OAUTH2_RS_ORIGIN_LANDING.clone(),
        SCHEMA_ATTR_OAUTH2_RS_SCOPE_MAP.clone(),
        SCHEMA_ATTR_OAUTH2_RS_SUP_SCOPE_MAP.clone(),
        SCHEMA_ATTR_OAUTH2_RS_TOKEN_KEY.clone(),
        SCHEMA_ATTR_OAUTH2_SESSION.clone(),
        SCHEMA_ATTR_PASSKEYS.clone(),
        SCHEMA_ATTR_PRIMARY_CREDENTIAL.clone(),
        SCHEMA_ATTR_PRIVATE_COOKIE_KEY.clone(),
        SCHEMA_ATTR_RADIUS_SECRET.clone(),
        SCHEMA_ATTR_RS256_PRIVATE_KEY_DER.clone(),
        SCHEMA_ATTR_SSH_PUBLICKEY.clone(),
        SCHEMA_ATTR_SYNC_COOKIE.clone(),
        SCHEMA_ATTR_SYNC_TOKEN_SESSION.clone(),
        SCHEMA_ATTR_UNIX_PASSWORD.clone(),
        SCHEMA_ATTR_USER_AUTH_TOKEN_SESSION.clone(),
        SCHEMA_ATTR_CREDENTIAL_TYPE_MINIMUM.clone(),
        SCHEMA_ATTR_WEBAUTHN_ATTESTATION_CA_LIST.clone(),
        // DL4
        SCHEMA_ATTR_OAUTH2_RS_CLAIM_MAP_DL4.clone(),
        SCHEMA_ATTR_OAUTH2_ALLOW_LOCALHOST_REDIRECT_DL4.clone(),
        // DL5
        // DL6
        SCHEMA_ATTR_LIMIT_SEARCH_MAX_RESULTS_DL6.clone(),
        SCHEMA_ATTR_LIMIT_SEARCH_MAX_FILTER_TEST_DL6.clone(),
        SCHEMA_ATTR_KEY_INTERNAL_DATA_DL6.clone(),
        SCHEMA_ATTR_KEY_PROVIDER_DL6.clone(),
        SCHEMA_ATTR_KEY_ACTION_ROTATE_DL6.clone(),
        SCHEMA_ATTR_KEY_ACTION_REVOKE_DL6.clone(),
        SCHEMA_ATTR_KEY_ACTION_IMPORT_JWS_ES256_DL6.clone(),
        // DL7
        SCHEMA_ATTR_PATCH_LEVEL_DL7.clone(),
        SCHEMA_ATTR_DOMAIN_DEVELOPMENT_TAINT_DL7.clone(),
        SCHEMA_ATTR_CERTIFICATE_DL7.clone(),
        SCHEMA_ATTR_OAUTH2_RS_ORIGIN_DL7.clone(),
        SCHEMA_ATTR_OAUTH2_STRICT_REDIRECT_URI_DL7.clone(),
        SCHEMA_ATTR_MAIL_DL7.clone(),
        SCHEMA_ATTR_LEGALNAME_DL7.clone(),
        SCHEMA_ATTR_DISPLAYNAME_DL7.clone(),
        // DL8
        SCHEMA_ATTR_LINKED_GROUP_DL8.clone(),
        SCHEMA_ATTR_APPLICATION_PASSWORD_DL8.clone(),
        SCHEMA_ATTR_ALLOW_PRIMARY_CRED_FALLBACK_DL8.clone(),
        // DL9
        SCHEMA_ATTR_DOMAIN_ALLOW_EASTER_EGGS_DL9.clone(),
        // DL10
        SCHEMA_ATTR_DENIED_NAME_DL10.clone(),
        SCHEMA_ATTR_LDAP_MAXIMUM_QUERYABLE_ATTRIBUTES.clone(),
        SCHEMA_ATTR_KEY_ACTION_IMPORT_JWS_RS256_DL6.clone(),
        // DL11
        SCHEMA_ATTR_APPLICATION_URL.clone(),
        // DL12
        SCHEMA_ATTR_IMAGE.clone(),
        SCHEMA_ATTR_OAUTH2_DEVICE_FLOW_ENABLE.clone(),
        SCHEMA_ATTR_MESSAGE_TEMPLATE.clone(),
        SCHEMA_ATTR_SEND_AFTER.clone(),
        SCHEMA_ATTR_DELETE_AFTER.clone(),
        SCHEMA_ATTR_SENT_AT.clone(),
        SCHEMA_ATTR_MAIL_DESTINATION.clone(),
        SCHEMA_ATTR_OAUTH2_ACCOUNT_PROVIDER.clone(),
        SCHEMA_ATTR_OAUTH2_ACCOUNT_UNIQUE_USER_ID.clone(),
        SCHEMA_ATTR_OAUTH2_ACCOUNT_CREDENTIAL_UUID.clone(),
        SCHEMA_ATTR_OAUTH2_CLIENT_ID.clone(),
        SCHEMA_ATTR_OAUTH2_CLIENT_SECRET.clone(),
        SCHEMA_ATTR_OAUTH2_AUTHORISATION_ENDPOINT.clone(),
        SCHEMA_ATTR_OAUTH2_TOKEN_ENDPOINT.clone(),
        SCHEMA_ATTR_OAUTH2_REQUEST_SCOPES.clone(),
        SCHEMA_ATTR_HMAC_NAME_HISTORY.clone(),
        SCHEMA_ATTR_ENABLED.clone(),
        SCHEMA_ATTR_IN_MEMORIAM.clone(),
        // DL13
        SCHEMA_ATTR_OAUTH2_CONSENT_PROMPT_ENABLE.clone(),
        SCHEMA_ATTR_S256.clone(),
        SCHEMA_ATTR_ACCOUNT_SOFTLOCK_EXPIRE.clone(),
        // DL14
...
pub fn phase_2_schema_classes() -> Vec<SchemaClass> {
    vec![
        SCHEMA_CLASS_DYNGROUP.clone(),
        SCHEMA_CLASS_ORGPERSON.clone(),
        SCHEMA_CLASS_POSIXACCOUNT.clone(),
        SCHEMA_CLASS_POSIXGROUP.clone(),
        SCHEMA_CLASS_SYSTEM_CONFIG.clone(),
        // DL4
        SCHEMA_CLASS_OAUTH2_RS_PUBLIC_DL4.clone(),
        // DL5
        SCHEMA_CLASS_ACCOUNT_DL5.clone(),
        SCHEMA_CLASS_OAUTH2_RS_BASIC_DL5.clone(),
        // DL6
        SCHEMA_CLASS_GROUP_DL6.clone(),
        SCHEMA_CLASS_KEY_PROVIDER_DL6.clone(),
        SCHEMA_CLASS_KEY_PROVIDER_INTERNAL_DL6.clone(),
        SCHEMA_CLASS_KEY_OBJECT_DL6.clone(),
        SCHEMA_CLASS_KEY_OBJECT_JWT_ES256_DL6.clone(),
        SCHEMA_CLASS_KEY_OBJECT_JWE_A128GCM_DL6.clone(),
        SCHEMA_CLASS_KEY_OBJECT_INTERNAL_DL6.clone(),
        // DL7
        SCHEMA_CLASS_SERVICE_ACCOUNT_DL7.clone(),
        SCHEMA_CLASS_SYNC_ACCOUNT_DL7.clone(),
        SCHEMA_CLASS_CLIENT_CERTIFICATE_DL7.clone(),
        // DL8
        SCHEMA_CLASS_ACCOUNT_POLICY_DL8.clone(),
        SCHEMA_CLASS_PERSON_DL14.clone(),
        // DL9
        SCHEMA_CLASS_OAUTH2_RS_DL9.clone(),
        // DL10
        SCHEMA_CLASS_DOMAIN_INFO_DL10.clone(),
        SCHEMA_CLASS_KEY_OBJECT_JWT_RS256.clone(),
        // DL11
        SCHEMA_CLASS_APPLICATION.clone(),
        // DL12
        SCHEMA_CLASS_KEY_OBJECT_HKDF_S256.clone(),
        SCHEMA_CLASS_OUTBOUND_MESSAGE.clone(),
        SCHEMA_CLASS_OAUTH2_ACCOUNT.clone(),
        SCHEMA_CLASS_OAUTH2_CLIENT.clone(),
        SCHEMA_CLASS_FEATURE.clone(),
        SCHEMA_CLASS_MEMORIAL.clone(),
        // DL 13
