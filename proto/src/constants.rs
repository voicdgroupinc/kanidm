...
pub const ATTR_OAUTH2_TOKEN_INTROSPECT_ENDPOINT: &str = "oauth2_token_introspect_endpoint";
...
pub const ATTR_OAUTH2_ACCOUNT_UNIQUE_USER_SUB: &str = "oauth2_account_unique_user_sub";
